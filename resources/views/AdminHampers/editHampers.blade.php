...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0" style="color: black;">Edit Hampers</h1>
            </div>
            <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{route('hampers.update',$hamper->id_hampers)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('deskripsi_hampers') is-invalid @enderror" name="deskripsi_hampers" value="{{ old('deskripsi_hampers', $hamper->deskripsi_hampers) }}" placeholder="Masukkan Deskripsi Hampers">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" class="form-control @error('harga_hampers') is-invalid @enderror" name="harga_hampers" value="{{ old('harga_hampers', $hamper->harga_hampers) }}" placeholder="Masukkan Harga">
                                    @error('harga_hampers')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
