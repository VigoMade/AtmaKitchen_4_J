        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{url('/createPembelianBB')}}" class="btn btn-md btn-success mb-3 btn-tambah-resep">Tambah Pembelian Bahan Baku </a>
                                ...
                                <table class="table table-hover textnowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Jumlah Pembelian Baku</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="#" method="POST">
                                                    <a href="{{url('/editPembelianBB')}}" class="btn btn-sm btn-primary">EDIT</a>
                                                    @csrf
                                                    @method('DELETE')
