            ...
            <div class="card mb-3" style="max-width: 100%;">
                <div class="row g-0">
                    <div class="col-md-4 d-flex align-items-center justify-content-center">
                        @if ($user->image)
                            <img src="{{ Storage::url($user->image) }}" class="img-fluid" alt="..."
                                style="max-width: 45%; height: 90%;">
                        @else
                            <img src="{{ asset('images/20240416153955.jpeg') }}" class="img-fluid "
                                style="max-width: 45%; height: 90%;" alt="default-profile">
                        @endif
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                action="{{route('alamat.delete', $address->id_alamat)}}" method="post">
                                @csrf
                                @method('DELETE')
                            ...
                            <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                action="{{route('alamat.setAktif', $address->id_alamat)}}" method="post">
                                @csrf
                                @method('PUT')
