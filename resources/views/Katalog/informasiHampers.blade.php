        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="card mx-auto" style="width: 20rem; cursor: pointer; padding: 10px;">
                    <div class="card-body">
                        <img src="/images/{{ $item->image }}" class="d-block w-100" alt="profile" style="width: 100%; height: 280px;">
                        <p style="text-align: center;"><b>{{$item->nama_hampers}}</b></p>
                        <p class="card-text text-center">Rp. {{$item->harga_hampers}}</p>
                        <a href="{{route('showHampers.showByIdHampers',$item->id_hampers)}}" class="btn btn-block" style="background-color: #AD343E; color: white;">Lihat Detail</a>
                    </div>
                </div>
            </div>
            @empty
