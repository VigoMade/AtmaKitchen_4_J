        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item">
                        <div class="dropdown">
                            <a class="btn btn-rounded dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                Konfirmasi
                            </a>
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item"
                                        href="{{route('konfirmasiPembayaran.index')}}">Pembayaran</a></li>
                                <li>
                                    <a class="dropdown-item" href="{{ route('indexKonfirmasiSaldo') }}">Saldo</a>
                                </li>
                    </li>
