            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto align-items-center">
                     <li class="nav-item {{ Request::is('gaji') ? 'active' : '' }}">
                        <a class="nav-link mx-2" href="{{url('/gaji')}}">Menu</a>
                    </li>
                    <li class="nav-item {{ Request::is('aboutUs') ? 'active' : '' }}">
    <a class="nav-link mx-2" href="{{ url('/aboutUs') }}" target="_blank">About</a>
</li>

                    <li class="nav-item">
                        <a class="nav-link mx-2" href="#!">Stores</a>
                    </li>

                     <li class="nav-item">
    <a class="btn btn-rounded" href="{#}">
      Cart  <img src="{{ asset('images/cart.png') }}" alt="Deskripsi Gambar" style="margin-right: 5px; width: 20px;">
    </a>
</li>
